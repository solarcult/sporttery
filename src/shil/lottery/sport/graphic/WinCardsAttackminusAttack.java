...
public class WinCardsAttackminusAttack {

	public static void main(String[] args) {
		new AbstractScatterPlotGraphic("Win.attack-Lose.attack","Win.attack-Lose.attack","Win.defense-Lose.defense") {
			...
			public XYDataset getDeltaCards() {
				...
				for(VSTeam vs : vsTeams)
				{
					...
					if(winCard!=null && loseCard!=null)
					{
						...
						double a = winCard.getAttack() - loseCard.getAttack();
						aget.add(a);
						double b = winCard.getDefense() - loseCard.getDefense();
						bget.add(b);
						if(a>=0&&b>=0) apbp++;
						if(a>=0&&b<0) apbn++;
						if(a<0&&b<0) anbn++;
					...
					{
						double e = daCard.getAttack() - dbCard.getAttack();
						eget.add(e);
						double f = daCard.getDefense() - dbCard.getDefense();
						fget.add(f);
